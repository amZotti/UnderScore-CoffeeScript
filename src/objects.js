...
(function() {
  ...
  filterObject = function() {
    ...
    whiteList = arguments[0], obj = arguments[1], keys = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
    keys = _.flatten(keys, true);
    fn = keys[0];
    result = {};
    _.each(obj, function(value, key) {
      var containsValue;
      containsValue = _.isFunction(fn) && fn(value) || __indexOf.call(keys, key) >= 0;
